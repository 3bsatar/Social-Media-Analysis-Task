...
def Girvan_Newman_algorithm(G):
    ...
    # Get the communities at the first level of the dendrogram
    top_level_communities = next(communities_generator)
    # Convert the communities into a list for easier handling
...
def NMI(G):
    ...
    node_colors = [colors[n] for n in nx.nodes(G)]
